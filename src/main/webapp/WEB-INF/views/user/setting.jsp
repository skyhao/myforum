    ...
    <div class="box">
        ...
        <form action="" class="form-horizontal" id="emailForm">
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" value="${sessionScope.curr_user.name}" readonly>
                </div>
            </div>
            <div class="control-group">
    ...
    <div class="box">
        ...
        <form action="" class="form-horizontal">
            <div class="control-group">
                ...
                <div class="controls">
                    <img src="http://7xs9b4.com1.z0.glb.clouddn.com/${sessionScope.curr_user.avatar}?imageView2/1/w/40/h/40"
                         class="img-circle avatar2" alt="">
                </div>
            </div>
            <hr>
...
<script>
    $(function () {
        ...
        <%--uploader.on("uploadCompelete", function(file){--%>
        <%--$(".webuplader-pick").text("上传新头像").removeAttr("disabled","disabled");--%>
        <%--});--%>
